    ...
    try:
        ...
        if len(speeds) != len(tau_list):
            ...
            with g1:
                ...
                ax1.set_ylabel("nCG [g]", fontsize=12)
                ax1.set_title("nCG vs Speed", fontsize=13)
            ...
            with g2:
                ...
                ax2.set_xlabel("Speed [knots]", fontsize=12)
                ax2.set_ylabel("nBow [g]", fontsize=12)
                ax2.set_title("nBow vs Speed", fontsize=13)
